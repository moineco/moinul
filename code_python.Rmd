...
# 2. Heroku server and oTree

#### 2.1. Deploy oTree application to Heroku server
...
#### 2.2 Necessary settings of Heroku to run small experiment
...
#### 2.3. Setup of Heroku server to activate the paid plans
