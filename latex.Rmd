...
\usepackage[margin=1in]{geometry}
\usepackage[english]{babel}
\usepackage{amsfonts,amssymb,array,arydshln,booktabs,boxedminipage,csquotes}
\usepackage{enumerate,epsfig,epstopdf,gensymb,graphicx,indentfirst,latexsym,multirow}
\usepackage{newfloat,oldgerm,rotating,setspace,siunitx,tabularx,threeparttable,times,url,xcolor}
\usepackage{subcaption}
\usepackage[noabbrev]{cleveref}
\usepackage[comma]{natbib}
\usepackage[normalem]{ulem}
