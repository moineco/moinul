...
% Package
\usepackage{alphabeta,amsfonts,amsmath,amssymb,array,arydshln,booktabs,boxedminipage,csquotes}
\usepackage{enumerate,epsfig,epstopdf,gensymb,graphicx,indentfirst,latexsym,multirow,newfloat,nomencl}
\usepackage{oldgerm,rotating,setspace,siunitx,subcaption,tabularx,textcomp,threeparttable,times,url,xcolor}
