...
#### To get the table or figure numbers according to your interest:

- For table  `\renewcommand\thetable{A1}` will be the trick.
...
- For figure, `\renewcommand\thefigure{A2}` will be the trick.
