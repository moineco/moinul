...
\usepackage[margin=1in]{geometry}
\usepackage[english]{babel}
\usepackage{amsfonts,amssymb,array,arydshln,booktabs,boxedminipage,csquotes,newfloat,enumerate,epsfig,epstopdf}
\usepackage{gensymb,graphicx,indentfirst,latexsym,multirow,oldgerm,rotating,setspace,tabularx,threeparttable,siunitx,times,url,xcolor}
\usepackage{subcaption}
\usepackage[noabbrev]{cleveref}
\usepackage[comma]{natbib}
\usepackage[normalem]{ulem}
