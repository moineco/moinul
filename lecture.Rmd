...
**Section 1: Foundations of geographic data in R and Python**

- Lecture 1: R and Python packages for GIS

- Lecture 2: Processing shapefiles in R and Python

- Lecture 3: Basic maps with R and Python

- Lecture 4: Part 1_spatial data operations

- Lecture 5: Part 2_spatial data operations

**Section 2: Extensions and intermediate techniques in R and Python**
