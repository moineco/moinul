...
-   To operational use of Emacs, we need to confirm that the following three files/folder (1) `.emacs`, (2) `.latexmkrc` and (3) `.emacs.d` are existing in the `Home` directory of the Ubuntu operating system.

-   Customize `.emacs`. By using your text editor in Ubuntu, create `.emacs` text file. Then you can write your customize codes inside this text file.

-   Customize `.latexmkrc`. By using your text editor in Ubuntu, create `.latexmkrc` text file. Then you can write the following codes inside this text file:
