...
- To complete this step, you need a text editor. In this tutorial, I am using `gedit` which is the official text editor of the GNOME desktop environment. If your PC doesnot contain it, you can install easily by using terminal.
