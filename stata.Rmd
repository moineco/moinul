...
### Stata 17 installation in linux
...
Again, Stata 17 will ask you for several conformations and you need to respond properly.

##### Step 5: Running Stata 17 with a graphical user interface using the command
