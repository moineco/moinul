...
(when we have the data for three rounds)

##### Independent variables

We assume that there should not be any differences between C and T1 at time period one.
...
We assume that there should be differences between C and T1 at time period two and three compared to time period one
...
(Statistical test to confirm that before treatment, C and T1 have no significant differences)
