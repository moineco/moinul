...
```{txt}
M-x # For windows keyboard you need to press (Alt+x)
    #For mac keyboard you need to press (Option+x)
```

```{txt}
List package # Choose the list packages by using keyboard arrow and press `Enter`
```
